-- ============================================================
-- consolidado_por_producto: p_equipo NULL → TODOS los equipos.
-- Habilita la vista "Total Empresa" del consolidado por producto (sólo admin;
-- el scope por rol lo resuelve la app antes de llamar al RPC).
-- ============================================================
